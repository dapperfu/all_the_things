...
VERSION=	3.6
srcdir=		/tmp/Python-3.6.6
VPATH=		/tmp/Python-3.6.6
abs_srcdir=	/tmp/Python-3.6.6
abs_builddir=	/projects/all_the_things


CC=		/usr/bin/clang-8 -pthread
CXX=		/usr/bin/clang-cpp-8
MAINCC=		$(CC)
...
prefix=		/projects/all_the_things/clang-8/python
...
CONFIG_ARGS=	 '--prefix=/projects/all_the_things/clang-8/python' 'CC=/usr/bin/clang-8' 'CXX=/usr/bin/clang-cpp-8' 'AR=/usr/bin/llvm-ar-8'
